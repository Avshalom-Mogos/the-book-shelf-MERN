...
import { Container,Card,Col, Toast, Button} from 'react-bootstrap';
        ...
        return (
            ...
            <div className="ReadMore">
               ...
               <Card.Text className="rating">
                 ...
                 <Card.Text>   { `pages:${this.props.book.volumeInfo.pageCount?this.props.book.volumeInfo.pageCount:"300"}`} </Card.Text>
