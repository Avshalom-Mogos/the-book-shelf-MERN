...
const ReadMore = (props) => {
    ...
    const { book, history, triggerLogin } = props;
        ...
        return (
            <div className="Search-toast-container">
                <Toast className="Search-toast" autohide
                    ...
                    <Toast.Body>"<strong>{book.volumeInfo.title}</strong>" was added to the cart!</Toast.Body>
                </Toast>
            </div>
        )
    };
    ...
    const addToCart = () => {
        ...
        axios.post("/cart", { id: user._id, book: book })
            .then((res) => {
                ...
                <Container>
                    ...
                    <Col >
                        {JSON.parse(sessionStorage.getItem("theBookShelf_user_login")) ?
                            ...
                            : <Button onClick={() => setRgisterBeforeAdd(true)} className="Add">Add To Cart</Button>}
                        <Button className="search" onClick={history.goBack} >Back to search</Button>
                    </Col>
                </Container>
            </Card>
        </div >
