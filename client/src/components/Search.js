...
export default class Search extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <h1>{`Search results for: ${this.searchParam}`}</h1>
                <div className="container">
                    ...
                    <Container>
                        <Row>
                            ...
                            <Col sm={3}>
                            <img src="http://books.google.com/books/content?id=w3NTAAAAcAAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"/> 
                            </Col>
                            <Col sm={3}>
                            <img src="http://books.google.com/books/content?id=w3NTAAAAcAAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api"/> 
                            </Col>
